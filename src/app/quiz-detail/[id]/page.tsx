...
export async function generateMetadata({
  ...
  try {
    ...
    // SEO 최적화된 설명 생성
    const description = `${data.category} - ${data.totalQuizCount} questions`;
    ...
    return {
      title: `${data.emoji} ${data.name} - Picktoss`,
      ...
      openGraph: {
        ...
        tags: [data.category, "quiz", "AI quiz", "learning"],
        images: [
          {
            url: `${baseUrl}/opengraph-quiz.png`,
            width: 1200,
            height: 630,
            alt: `${data.name} - ${data.category} quiz`,
            type: "image/png",
          },
        ],
      },
    ...
    return {
      title: "Picktoss: AI Quiz for Growth",
      description: fallbackDescription,
      keywords: "quiz, AI quiz, learning, education, Picktoss, online quiz",
      ...
      twitter: {
        ...
        site: "@picktoss",
        title: "Picktoss: AI Quiz for Growth",
        description: "A smart quiz experience that helps you grow",
        images: [
          {
            url: `${baseUrl}/opengraph-quiz.png`,
            alt: "Picktoss - AI Quiz Platform",
  ...
  try {
    ...
    if (response.ok) {
      ...
      jsonLd = {
        ...
        name: data.name,
        description: `${data.category} - ${data.totalQuizCount} questions`,
        creator: {
          "@type": "Person",
          name: data.creator,
        },
        ...
        keywords: [data.category, "quiz", "AI quiz", "learning"].join(", "),
        about: {
          "@type": "Thing",
          name: data.category,
        },
  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>
          {quizData
            ? `${quizData.emoji} ${quizData.name} - Picktoss`
            : "Picktoss Quiz"}
        </title>
        <meta
          name="description"
          content={
            quizData
              ? `${quizData.category} - ${quizData.totalQuizCount} questions`
              : "A smart AI quiz platform to help you grow. Learn with fun quizzes across various categories."
          }
        />
        {jsonLd && (
      ...
      <body>
        <header>
          <nav>
            <h1>Picktoss</h1>
            <p>AI quizzes that help you grow</p>
          </nav>
        </header>
        ...
        <main>
          {quizData ? (
            <article>
              <header>
                ...
                <div>
                  ...
                  <span>Creator: {quizData.creator}</span>
                  <span>Total {quizData.totalQuizCount} questions</span>
                </div>
              </header>
              ...
              <section>
                <h2>Quiz Info</h2>
                <ul>
                  <li>Attempts: {quizData.tryCount}</li>
                  <li>Bookmarks: {quizData.bookmarkCount}</li>
                  <li>
                    Created:{" "}
              ...
              {quizData.quizzes && quizData.quizzes.length > 0 && (
                <section>
                  ...
                  <p>
                    This quiz includes {quizData.quizzes.length} questions. Learn
                    key concepts in {quizData.category}.
                  </p>
                  <div>
                      ...
                      <article key={quiz.id}>
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <p>
                              This question covers core concepts in{" "}
                              {quizData.category}. Find answers and full
                              explanations on Picktoss.
                            </p>
                          </div>
                        </div>
                      </article>
              ...
              <section>
                <h2>Learn on Picktoss</h2>
                <p>
                  You can solve this quiz on the Picktoss platform. Enjoy
                  AI-generated questions and learn with fun.
                </p>
                <p>
                  After solving, deepen your understanding with detailed
                  explanations.
                </p>
              </section>
            </article>
            ...
            <article>
              <h1>Picktoss Quiz</h1>
              <p>Enjoy smart AI-made quizzes and learn with fun.</p>
              <p>A variety of categories are ready for you.</p>
            </article>
          )}
        </main>

        <footer>
          <p>© 2024 Picktoss. All rights reserved.</p>
          <p>AI quiz platform for growth</p>
        </footer>
      </body>
    </html>
  );
